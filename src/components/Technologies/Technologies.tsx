        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
          {technologies.map(({ name, icon: Icon, color }) => (
            <div
              ...
              className="group flex flex-col items-center justify-center gap-3 p-6 rounded-2xl bg-zinc-900 border border-zinc-800 hover:border-lime-500/50 hover:-translate-y-1 transition-all duration-300"
            >
